...
\begin{abstract}
Supportmedewerkers verwerken dagelijks tickets die vaak bestaan uit lange en ongestructureerde e-mailconversaties. Het manueel samenvatten van deze informatie is tijdrovend en leidt tot inconsistente documentatie. In deze graduaatsproef wordt een proof of concept uitgewerkt die gebruikmaakt van Azure OpenAI om automatisch kernachtige samenvattingen te genereren van support-e-mails. De oplossing werd ontwikkeld als een afzonderlijke demo-applicatie en toont aan hoe artificiële intelligentie kan bijdragen tot efficiëntere ticketafhandeling en betere kennisopbouw binnen supportteams.
\end{abstract}
