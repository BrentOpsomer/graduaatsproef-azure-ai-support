...
\section{Resultaten}
De proof of concept toont aan dat Azure OpenAI in staat is om lange support-e-mails snel en accuraat samen te vatten. De gegenereerde samenvattingen zijn duidelijk, consistent en direct bruikbaar in een ticketsysteem.

\begin{center}
  \captionsetup{type=figure}
  \includegraphics[width=0.8\linewidth]{demoUi_volledig}
  \captionof{figure}{Demo van automatische e-mailsamenvatting in de webapplicatie}
\end{center}



Dit leidt tot een betere leesbaarheid van tickets en ondersteunt snellere probleemanalyse door supportmedewerkers.
